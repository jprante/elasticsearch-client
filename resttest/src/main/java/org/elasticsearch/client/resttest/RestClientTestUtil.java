...
package org.elasticsearch.client.resttest;
...
public final class RestClientTestUtil {
    ...
    public static String randomHttpMethod(Random random) {
        return RandomPicks.randomFrom(random, HTTP_METHODS);
    }

    public static int randomStatusCode(Random random) {
        return RandomPicks.randomFrom(random, ALL_STATUS_CODES);
    }

    public static int randomOkStatusCode(Random random) {
        return RandomPicks.randomFrom(random, OK_STATUS_CODES);
    }

    public static int randomErrorNoRetryStatusCode(Random random) {
        return RandomPicks.randomFrom(random, ERROR_NO_RETRY_STATUS_CODES);
    }

    public static int randomErrorRetryStatusCode(Random random) {
        return RandomPicks.randomFrom(random, ERROR_RETRY_STATUS_CODES);
    }

    public static List<Integer> getOkStatusCodes() {
        return OK_STATUS_CODES;
    }

    public static List<Integer> getAllErrorStatusCodes() {
     ...
     */
    public static Header[] randomHeaders(Random random, final String baseName) {
