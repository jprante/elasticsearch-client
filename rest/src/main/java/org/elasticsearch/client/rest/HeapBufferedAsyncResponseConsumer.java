...
public class HeapBufferedAsyncResponseConsumer extends AbstractAsyncResponseConsumer<HttpResponse> {
    ...
    @Override
    public void onEntityEnclosed(HttpEntity entity, ContentType contentType) throws IOException {
     ...
     */
    public ByteBufferAllocator getByteBufferAllocator() {
        return HeapByteBufferAllocator.INSTANCE;
    }

    @Override
    public void onContentReceived(ContentDecoder decoder, IOControl ioctrl) throws IOException {
