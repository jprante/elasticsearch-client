...
public final class RequestLogger {
     ...
     */
    public static void logResponse(Log logger, HttpUriRequest request, HttpHost host, HttpResponse httpResponse) {
     ...
     */
    public static void logFailedRequest(Log logger, HttpUriRequest request, HttpHost host, Exception e) {
        if (logger.isDebugEnabled()) {
    ...
    public static String buildWarningMessage(HttpUriRequest request, HttpHost host, Header[] warnings) {
     ...
     */
    public static String buildTraceRequest(HttpUriRequest request, HttpHost host) throws IOException {
     ...
     */
    public static String buildTraceResponse(HttpResponse httpResponse) throws IOException {
