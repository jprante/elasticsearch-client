...
public class RestClient implements Closeable {
    ...
    public RestClient(CloseableHttpAsyncClient client, long maxRetryTimeoutMillis, Header[] defaultHeaders,
    ...
    public void performRequestAsyncNoCatch(String method, String endpoint, Map<String, String> params,
                                    HttpEntity entity, HttpAsyncResponseConsumerFactory httpAsyncResponseConsumerFactory,
                                    ResponseListener responseListener, Header... headers) {
    ...
    public static class FailureTrackingResponseListener {
        ...
        public FailureTrackingResponseListener(ResponseListener responseListener) {
         ...
         */
        public void onDefinitiveFailure(Exception exception) {
         ...
         */
        public void trackFailure(Exception exception) {
