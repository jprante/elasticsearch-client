...
import org.elasticsearch.client.rest.HeapBufferedAsyncResponseConsumer;
import org.elasticsearch.client.rest.HttpAsyncResponseConsumerFactory;
...
public class HeapBufferedAsyncResponseConsumerTests extends RestClientTestCase {
    ...
    public void testResponseProcessing() throws Exception {
        ...
        assertEquals(TEST_BUFFER_LIMIT, consumer.getBufferLimit());
    ...
    public void testCanConfigureHeapBufferLimitFromOutsidePackage() throws ClassNotFoundException, NoSuchMethodException,
        ...
        Constructor<?> constructor = HttpAsyncResponseConsumerFactory.
                HeapBufferedResponseConsumerFactory.class.getConstructor(Integer.TYPE);
